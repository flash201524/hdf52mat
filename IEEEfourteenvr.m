...
for i = 1:10000
    % 将数字i转换为字符串，然后拼接路径
    path1 = strcat('/', num2str(i), '/vr_Bus_01');
    path2 = strcat('/', num2str(i), '/vr_Bus_02');
    path3 = strcat('/', num2str(i), '/vr_Bus_03');
    path4 = strcat('/', num2str(i), '/vr_Bus_06');
    path5 = strcat('/', num2str(i), '/vr_Bus_08');
