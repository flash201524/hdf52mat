% 设置用户路径
userpath('E:\coding\hdf52mat\SevenBus');  % 使用单引号，确保路径正确
...
for i = 1:3200
    % 将数字i转换为字符串，然后拼接路径
    path1 = strcat('/', num2str(i), '/GEN1/vr');
    path2 = strcat('/', num2str(i), '/GEN1/vr');
    path3 = strcat('/', num2str(i), '/GEN1/vr');
...
mts.train = train;
mts.trainlabels = int32(labels(1:3200));
mts.test = test;
mts.testlabels = int32(labels(3201:4000));
